...
<body>
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="index.php?act=xemtk"><button class="dropdown-item" type="button">Xem Hồ Sơ</button></a>
                            <a href="index.php?act=updatetk"><button class="dropdown-item" type="button">Sửa thông tin tài khoản</button></a>
    ...
    <div class="container-fluid bg-dark mb-30">
        ...
        echo ' <a href="'.$linkdm.'" class="nav-item nav-link">'.$ten_loai.'</a>';
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="index.php?act=ctsanpham" class="nav-item nav-link">Chi tiết</a>

                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-sm btn-light dropdown-toggle"
                            data-toggle="dropdown"><?= $ten_dang_nhap ?></button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="index.php?act=xemtk"><button class="dropdown-item" type="button">Xem Hồ
                                    Sơ</button></a>
                            <a href="index.php?act=updatetk"><button class="dropdown-item" type="button">Sửa thông tin
                                    tài khoản</button></a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="index.php?act=dangky"><button class="dropdown-item" type="button">Đăng Ký
                                    </button></a>
                                <a href="index.php?act=dangnhap"><button class="dropdown-item" type="button">Đăng
                                        Nhập</button></a>
            ...
            <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
                <div class="col-lg-4">
                    <a href="" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary bg-dark px-2">PAT</span>

...
<div class="col-md-6 form-group">
    ...
    <input class="form-control" type="text" name="ten_dang_nhap" value="<?php echo $ten_dang_nhap; ?>">
</div>
<div class="col-md-6 form-group">
...
<div class="col-md-6 form-group">
    ...
    <input class="form-control" type="text" name="mat_khau" value="<?php echo $mat_khau; ?>">
</div>
<div class="col-md-6 form-group">
    <label>E-mail</label>
...
<div class="col-md-6 form-group">
    ...
    <input class="form-control" type="date" name="ngay_sinh" value="<?php echo $ngay_sinh; ?>">
</div>
<div class="col-md-6 form-group">
    <label>Địa Chỉ</label>
...
<div class="col-md-12 form-group">
    ...
    <input type="submit" value="Cập nhật" id="capnhat" class="btn btn-primary">
